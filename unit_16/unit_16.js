...
function f3() {
    ...
    console.log(div3);
    for (let item of div3) {
        item.textContent = 3;
        div31 = item.textContent;
    }

    document.querySelector('.out-3').innerHTML = div31;
}
...
function f4() {
    ...
    let div41 = div4.textContent;
    console.log(div4)
    for (let item of div4) {
        item.textContent = 4;
        div41 = item.textContent;

    }
    document.querySelector('.out-4').innerHTML = div41;
}
...
function f9() {
    ...
    //     }
    // }
    return (max.length - 1); //return out;

    // Второй способ (По факту решения одинаковы)
    // let max = a9[0].length;
    // for (let item of a9) {
    //     if (max < item.length) {
    //         max = item.length;
...
function f15() {
    let div15 = document.querySelectorAll('.out-15');
    let div151 = div15.textContent;

    for (let item of div15) {
        item.textContent = 15;
        div151 = item.textContent;
    }
    document.querySelector('.out-15').innerHTML = div151;
}
