...
function f5() {
    let out5 = out4.classList.contains('bg-4');
...
function f18() {
    let out18 = document.querySelector('.p-18').getAttribute('data-b');
...
function f20() {
    document.querySelector('.out-20').setAttribute('data-title', 'go');
}
