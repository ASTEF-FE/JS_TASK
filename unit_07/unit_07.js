...
document.querySelector('.b-4').onclick = function () {
    document.querySelector('.out-4').textContent = t4(2000);
}
...
function t5(yourName) {
    ...
    let c = `Hello ${yourName}`;
    return c;
}

document.querySelector('.b-5').onclick = function () {
    document.querySelector('.out-5').textContent = t5('Artur');
}
...
function t6(a, b) {
    a = Math.ceil(a); //Округляет вверх (до ближайшего большего целого)
    b = Math.floor(b);//Округляет вниз (до ближайшего меньшего целого целого)
...
d = 225;
function t7() {
    q = Math.ceil(q); //Округляет вверх (до ближайшего большего целого)
    d = Math.floor(d);//Округляет вниз (до ближайшего меньшего целого целого)
    x = Math.floor(Math.random() * (d - q)) + q;
    y = Math.floor(Math.random() * (d - q)) + q;
    z = Math.floor(Math.random() * (d - q)) + q;
    // console.log(`${x}`, y, z);
    ...
    console.log(`${t6(0, 255)},${t6(0, 255)},${t6(0, 255)}`);
